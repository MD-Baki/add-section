...
const Cards = ({ featuredItems }) => {
    ...
    return (
        <div className="rounded-lg shadow-lg">
            <img src={image} alt="" className="h-[250px] w-full rounded-t-lg" />
            <div className="p-4">
                ...
                <div className="grid grid-cols-2 gap-1 pt-4">
                    <button class="w-full relative px-5 py-3 overflow-hidden font-medium text-gray-600 bg-gray-100 border border-gray-100 rounded-lg shadow-inner group">
